...
* **[ ] Region.ini Information:** All regional information should be kept in the portal database.  No region specific ini files should be needed for robust or region
...
* **[ ] Full UI, including CSS, Sweep:** review all CSS and inline style to make sure it makes sense and is centalized in the css file for easy theming.  (AI suggested the sweep, especially on .group and .card)
